...
## ★ O APK (§240 servidor-apontado · §243 imersivo) — pronto para o dono gerar no Android Studio. App aponta para o Render; publicar atualiza sem reinstalar. APK NÃO gerado aqui (sem SDK/aparelho) — o run e a medição do ganho exato são do dono, pelo `PUBLICAR-APK.md`.
