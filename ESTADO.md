...
**Babás:** `tests/colecao_tela.test.js` (45 asserções, reescrito p/ §284) + `desafios`/`maestria` migradas. Verificação Chromium (§284): 18 checagens + 4 capturas em `docs/capturas-284/`. Suíte + build verdes. **Arquivos:** `src/ui/home.js`, `src/view.js`, `src/shell.html`, `tests/*`. Ver DECISOES §284 (com o modelo de maestria).
