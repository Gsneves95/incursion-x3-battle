...
## ★ O APK (§240) — modelo SERVIDOR-APONTADO, pronto para o dono gerar no Android Studio. O app aponta para o Render; publicar atualiza o app sem reinstalar. APK NÃO gerado aqui (sem SDK/aparelho) — o run é do dono, pelo `PUBLICAR-APK.md`.
