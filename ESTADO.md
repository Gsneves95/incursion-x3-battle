...
## ★ FASE 6 (começou) — AS MISSÕES. O PvP existe (§223–§226), então elas nascem com produtor (§95 satisfeito, o que o §189 antecipou). Invariante: a missão LIBERA deus (progressão) → o SERVIDOR é o dono, como os pontos (§226).
