...
- **Prólogo I (A Era dos Planos)** — identidade, **sem `certa`** (é o único do tipo: antes da fusão não há quem ler). 4 planos (Olimpo/Asgard/Duat/Xibalba); consequência `emprestado` no **Prólogo VI** (o único ato em que o time é do jogador). **Autorado, sinalizado (não estava na fonte, que nomeia os planos mas não os deuses):** o mapa plano→deus — Olimpo→**zeus**, Asgard→**thor**, Duat→**sobek**, Xibalba→**kukulkan** (o deus mais icônico de cada panteão, todos presentes/adjacentes ao Prólogo) — e as 4 pistas de plano + as 4 linhas de revelação. Baixo risco: o emprestado é **trocável** no ato VI (risco nenhum), então uma escolha temática "errada" é recuperável em jogo. Sujeito a revisão do dono.
