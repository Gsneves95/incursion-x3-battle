...
**PERGUNTA ABERTA (dono, anotar sem mexer): "precisa de dica" pode às vezes ser "o time está errado".** Se o dionisio control-pesado fechar SEM dica (como o boto), então a dica do POSEIDON também pode ser desnecessária com o time certo — teríamos fechado o poseidon com a correção mais FÁCIL (dica) em vez da CERTA (time). Não mexer no poseidon agora; revisitar quando o padrão tiver mais casos. (A ordem correta de correção, à luz do erro do dionisio: isolamento → time → dica → afrouxar; a dica NÃO é a primeira tentativa quando o isolamento mostra o dano perto.)
